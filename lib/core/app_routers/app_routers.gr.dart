...
abstract class $AppRouters extends _i8.RootStackRouter {
...
/// generated route for
/// [_i1.CourseCartView]
class CourseCartView extends _i8.PageRouteInfo<void> {
  const CourseCartView({List<_i8.PageRouteInfo>? children})
      : super(
          CourseCartView.name,
...
/// generated route for
/// [_i2.CourseDetails]
class CourseDetails extends _i8.PageRouteInfo<CourseDetailsArgs> {
  CourseDetails({
    _i9.Key? key,
  ...
  static const _i8.PageInfo<CourseDetailsArgs> page =
      _i8.PageInfo<CourseDetailsArgs>(name);
}
...
class CourseView extends _i8.PageRouteInfo<void> {
  const CourseView({List<_i8.PageRouteInfo>? children})
      : super(
          CourseView.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i6.PreviewCourseVideos]
class PreviewCourseVideos extends _i8.PageRouteInfo<PreviewCourseVideosArgs> {
  PreviewCourseVideos({
    _i9.Key? key,
    required String courseId,
  ...
  static const _i8.PageInfo<PreviewCourseVideosArgs> page =
      _i8.PageInfo<PreviewCourseVideosArgs>(name);
}
