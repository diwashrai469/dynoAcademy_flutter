...
_$MyCoursesResponseModelImpl _$$MyCoursesResponseModelImplFromJson(
...
Map<String, dynamic> _$$MyCoursesResponseModelImplToJson(
        _$MyCoursesResponseModelImpl instance) =>
    <String, dynamic>{
...
_$DataImpl _$$DataImplFromJson(Map<String, dynamic> json) => _$DataImpl(
      ...
      iV: json['iV'] as int?,
      expiryAlerted: json['expiry_alerted'] as bool?,
      expiryAlertedTime: json['expiry_alerted_time'] as String?,
      lastPlayedLessonId: json['last_played_lesson_id'] as String?,
...
Map<String, dynamic> _$$DataImplToJson(_$DataImpl instance) =>
    <String, dynamic>{
      ...
      'iV': instance.iV,
      'expiry_alerted': instance.expiryAlerted,
      'expiry_alerted_time': instance.expiryAlertedTime,
      'last_played_lesson_id': instance.lastPlayedLessonId,
      'id': instance.id,
    };
